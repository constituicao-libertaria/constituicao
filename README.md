...
- Aborto pode ser fatal psicologicamente. Cuidado com as consequências. Por mais que tenha sido fruto de um estupro, o bebê não tem culpa, ele é uma vida inocente. Sendo de uma relação normal, o bebê não tem culpa de sua irresponsabilidade. Prefira sempre a adoção, prefira sempre a vida;
...
Art. 24. A sociedade brasileira rege-se pela observância dos seguintes princípios:
...
Art. 25. O sistema de votação é digital e não obrigatório. Quem não votar será submetido as decisões da maioria.

Art. 26. Cada cidadão poderá votar pelo seu celular, computador ou qualquer outro dispositivo eletrônico.

Art. 27. O software de votação é de código aberto e acessível a qualquer pessoa para auditoria, verificação e participação.

Art. 28. O código-fonte é acessível pelo navegador, sem necessidade de autenticação e/ou autorização de qualquer tipo.

Art. 29. A votação geral é feita a cada dois anos para eleger os representantes do povo.

Art. 30. A votação é separada em 3 fases inicialmente, podendo ir para 4 para cargos no executivo. A primeira fase se inicia às 8h e termina às 12h. A segunda fase entre 13h e 15h. A terceira e última fase entre 16h e 18h.

Art. 31. Já a quarta fase, que é excepcional, somente acontece caso o candidato mais votado não tenha mais de 60% dos votos válidos. Neste caso, a votação é feita entre os dois candidatos mais votados, sendo um o primeiro da lista de votos úteis e o outro o primeiro da lista dos preferidos. A votação final é feita entre 19h e 21h.

Art. 32. Na primeira fase, a votação para qualquer cargo deve ser feita para 2 candidatos, sendo que cada candidato compete com o outro. Então se for para votação de prefeito e existir os candidatos A, B, C e D, a pessoa poderá votar em A e B, A e C, A e D, B e C, e assim por diante. Vide análise combinatória.

Art. 33. Ao se votar num candidato, deverá ser indicado qual candidato representa o preferido.

Art. 34. O candidato que não receber o voto preferido é classificado como voto útil.

Art. 35. Ao concluir a primeira fase, será mostrado o resultado da votação para cada cargo. As pessoas podem filtrar de diversas maneiras, sabendo quem são os mais votados de maneira geral, quem são os mais votados na lista de candidatos preferidos, quem são os mais votados na lista de votos úteis, e assim por diante.

Art. 36. Na segunda fase a votação é feita somente para os primeiros 3 candidatos da lista de votos úteis e preferidos, totalizando até 6 candidatos. O mesmo processo da primeira fase é repetido.

Art. 37. Na terceira fase a votação é feita somente para os primeiros 2 candidatos da lista de votos úteis e preferidos, totalizando 4 candidatos. O mesmo processo da primeira fase é repetido.

Art. 38. A cada 6 meses todos os cidadãos poderão votar pelo celular para classificar o governo corrente entre 1 e 10. Se a média for menor que 5 por 3 votações consecutivas, o governo é destituído e novas eleições são convocadas.

Art. 39. Só são eleitas pessoas que receberam votos diretos. Se existir 10 vagas e disputarem 1000 pessoas, as 10 primeiras que receberam mais votos diretos serão eleitas. Ou seja, não existe quociente eleitoral ou qualquer outra regra que não seja a quantidade de votos diretos.

Art. 40. Assim que uma eleição é convocada, o processo deve ser feito em até 60 dias.

## TÍTULO III - Partidos políticos e candidaturas

Art. 41. O alistamento eleitoral é obrigatório para candidatura, sendo facultada a filiação partidária ou a candidatura independente para cargos eletivos.

Art. 42. São livres a criação, a fusão, a incorporação e a extinção de partidos políticos.

Art. 43. O financiamento de partidos políticos é livre, isto é, pode ser feito por qualquer pessoa ou organização, com exceção do Estado.

Art. 44. É assegurada ao partido político autonomia para definir sua estrutura interna, devendo seu estatuto estabelecer normas de disciplina e fidelidade partidária.

Art. 45. Os cidadãos podem se candidatar para qualquer cargo, desde que tenham idade mínima de 35 anos e sejam brasileiros natos ou naturalizados. Não existe qualquer outra restrição.

## TÍTULO IV - Organização do Estado Brasileiro

Art. 46. A República do Brasil é composta pela União e cidades-estado, entidades 100% autônomas organizadas a partir do princípio da subsidiariedade de competências, nos termos desta Constituição.

Art. 47. Uma cidades-estado, para ser considerada como tal, deve ter pelo menos 1 milhão de habitantes. Cidades que possuem menos devem ser incorporadas.

Art. 48. É vedado barreira alfandegaria seja na nação ou nas cidades-estado.

Art. 49. Os entes federados são autônomos, exceto na medida em que sua autonomia seja limitada pela Constituição, cabendo a eles exercer todos os direitos que não pertencem à Federação.

Art. 50. As cidades-estado organizam-se e regem-se pela Constituição e leis que adotarem, observados os princípios desta Constituição. São reservadas as cidades-estado as competências que não lhes sejam vedadas por esta Constituição.

Art. 51. Compete à União legislar sobre:
...
Art. 52. Nenhuma lei federal será proposta para regulamentar:
...
Art. 53. Compete a União e as cidades-estado legislar concorrentemente sobre:
