...
- Todos que dizem defender a democracia para executar atos que não respeitam esta Constituição, estão atacando a democracia na verdade. Isso é demonstrável pelo mesmo argumento usado pela ditadura militar no Brasil em 1964;
...
- A pessoa que tenha a liberdade de morar em diversos países temporariamente tem a capacidade de experimentar diversas jurisdições e escolher a melhor para si, contudo ela é obrigada a deixar sua cultura e família para trás na maioria das vezes. Esta Constituição defende essa liberdade mas dentro de uma mesma nação com a viabilização de concorrência entre cidades-estado;
...
- Uma cidades-estado, para ser considerada como tal, deve ter pelo menos 300 mil habitantes. Cidades que possuem menos devem ser incorporadas;
